  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .menu-btn {
      ...
      min-height: 44px; min-width: 44px; display: inline-flex; align-items: center; gap: 6px;
      touch-action: manipulation; -webkit-user-select: none; user-select: none;
      -webkit-tap-highlight-color: transparent;
    }
    .menu-btn:hover { color: #ccc; border-color: #555; }
    .menu-dropdown {
    ...
    .menu-item.danger:hover { background: #2a0a0a; }
    .menu-divider { border: none; border-top: 1px solid #2a2a2a; margin: 4px 0; }
    .btn {
      padding: 8px 16px;
      border-radius: 6px;
      font-size: 13px;
...
<header>
  ...
  <div class="header-actions">
    ...
    <div class="menu-wrap">
      <button class="menu-btn" onclick="toggleMenu(event)">☰ More</button>
      <div class="menu-dropdown" id="main-menu">
        <a href="order-history.php" class="menu-item">📋 Order History</a>

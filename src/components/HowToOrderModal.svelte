...
<!-- Compact Trigger Button - Positioned to the right -->
<div class="trigger-container">
  <button on:click={openModal} class="trigger-btn">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <div class="header-content">
          <h2 class="modal-title">How to Order</h2>
          <p class="modal-subtitle">4 simple steps to get your products</p>
        </div>
      </div>
      ...
      <div class="modal-body">
        <div class="steps-grid">
          ...
          <div class="step-card">
            ...
            <h3 class="step-title">Browse the Shop</h3>
            <p class="step-desc">Find products in our Shop page</p>
          </div>
          ...
          <div class="step-card">
            ...
            <h3 class="step-title">Add to Basket</h3>
            <p class="step-desc">Tap "Add to Basket" on items you want</p>
          </div>

          <!-- Step 3 - Highlighted -->
          <div class="step-card step-highlight">
            <div class="step-number">3</div>
            <div class="step-icon whatsapp-icon">
            ...
            <h3 class="step-title">Send via WhatsApp</h3>
            <p class="step-desc">Open basket, tap "Order via WhatsApp"</p>
          </div>
          ...
          <div class="step-card">
            ...
            <p class="step-desc">Pay on pickup — MoMo, Orange Money or Cash</p>
          </div>
        ...
        <div class="payment-methods">
          ...
          <span class="payment-badge">Cash on Pickup</span>
        </div>
      </div>

      <!-- Footer -->
      <div class="modal-footer">
        <button on:click={closeModal} class="btn-secondary-modal">
          Got it
        </button>
        <a

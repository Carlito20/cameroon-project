...
const result = [];
const seen   = new Set();
const add    = (name, qty) => { if (!seen.has(name)) { seen.add(name); result.push({ name, quantity: qty }); } };
